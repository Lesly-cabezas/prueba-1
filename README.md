...
## Ensayo de compresión del concreto

La siguiente imagen representa el ensayo de compresión aplicado a una probeta cilíndrica de concreto, utilizado para determinar su resistencia mecánica.

![Ensayo de compresión del concreto](images/ensayo_compresion_concreto.png)
